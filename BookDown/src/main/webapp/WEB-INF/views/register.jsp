    ...
    <div class="content-wrap">
        <div class="content">
            ...
            <div class="container" style="padding-top:1px">
                ...
                <form id="registerform" role="form" method="post" class="well" style="width: 40em; margin: 12px auto ">
                    <h3>用户注册</h3>
                    ...
                    <div class=" form-group input-group input-group-md" style="padding-top: 6px">
                    ...
                    <div class=" form-group input-group input-group-md" style="padding-top: 6px">
                            <span class="input-group-addon" id="sizing">
                                <i class="fa fa-lock"></i>
                            </span> <input type="password" id="reuPwd" name="confirmPwd" class="form-control col-sm-3"
                                           placeholder="请再次输入密码"/>
                    </div>

                    <div class="form-group" style="padding-top: 6px">
                        <label class="control-label">性别：
                            <input class="control-label" type="radio" name="uSex" value="1" checked> 男 &nbsp;
                            <input class="control-label" type="radio" name="uSex" value="0"> 女
                        </label>
                    </div>
                    <div class=" form-group input-group input-group-md">
                            <span class="input-group-addon" id="sizing-addon2">
                                <i class="fa fa-mobile"></i>
                            </span> <input type="text" id="uPhone" name="uPhone" class="form-control"
                                           placeholder="请输入手机号"/>
                    </div>
                    <br>

                    <button type="button" id="registercommit" class="btn btn-success btn-block">注册</button>
                    <a class="btn btn-sm btn-white btn-block" style="text-align: right;"
                       href="/login"><h6>已有账户？前往登录</h6></a>
                </form>
