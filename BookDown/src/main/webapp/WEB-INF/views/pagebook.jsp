    ...
    <div class="content-wrap">
        <div class="content">
            <header class="archive-header">
                <h1>最新发布:第${bookPage.currPage}页</h1>
            </header>
            ...
            <div class="pagination">
                <ul>
                    <li><a href="/page?pn=1">首页</a></li>
                    <c:choose>
                        <c:when test="${bookPage.currPage !=1}">
                            <li class="prev-page"><a href='/page?pn=${bookPage.currPage-1}'>上一页</a></li>
                        </c:when>
                    </c:choose>
                    ...
                    <c:choose>
                        <c:when test="${bookPage.currPage !=bookPage.totalPage}">
                            <li class="next-page"><a href="/page?pn=${bookPage.currPage+1}">下一页</a></li>
                        </c:when>
                    </c:choose>
                    <%--末页--%>
                    <li><a href="/page?pn=${bookPage.totalPage}">末页</a></li>
                </ul>
            </div>
