...
<head>
    ...
    <link href="../../css/plugins/bootstrap-fileupload.css" rel="stylesheet">
    ...
    <div class="content-wrap">
        <div class="content">
            <div class="container" style="padding-top:1px">
                <h1 class="h1">个人中心</h1> <br>
                <div class="row">
                    <div class="col-md-offset-2 col-md-8 ">
                        <div class="form-group" style="margin-right: 260px;">
                            <form role="form" id="updateUserInfo" class=" form-horizontal">
                                <div class="form-group">
                                    <label class="control-label col-sm-3" style="text-align: left">个性头像：</label>
                                    <div class="col-sm-5">
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 190px; height: 190px;">
                                                <img src="${user.uPhoto}" alt=""/>
                                            </div>
                                            <div class="fileupload-preview fileupload-exists thumbnail"
                                                 style="max-width: 190px; max-height: 190px; line-height: 20px; "></div>
                                            <div style="margin-left: 20px;">
													<span class="btn btn-file">
                                                        <span class="fileupload-new">选择图片</span>
													    <span class="fileupload-exists">更换</span>
													    <input type="file" id="adduPhoto"
                                                               class="default"/>
                                                    </span>
                                                <a href="javascript:void(0); " class="btn fileupload-exists" id="uploadImage">上传</a>
                                                <%--隐藏图片上传成功 传回来的地址--%>
                                                <input type="text" id="hiddenUserImg" name="uPhoto" style="display: none">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-2 control-label" style="margin-top: 10px;">用户ID :</label>
                                    <div class="col-md-4" style="margin-left: 2px;">
                                        <p class="form-control-static">${user.uId}</p>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label" style="margin-top: 10px;">用户名 :</label>
                                    <div class="col-md-4" style="margin-left: 2px;">
                                        <p class="form-control-static">${user.uName}</p>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-top:10px;margin-right: 10px;">
                                    <label class="col-md-2 control-label" style="margin-top: 10px;">手机号:</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group" style="margin-right: 90px;">
                                    <label class="col-md-2 control-label" style="margin-top: 10px;">邮箱:</label>
                                ...
                                <div class="form-group" style="margin-right: 90px;">
                                    <label class="col-md-2 control-label" style="margin-top: 10px;">密码:</label>
                                    <div class="col-md-8" style="padding-left: 25px;">
                                        <input type="password" class="form-control span6" id="uPwd" name="uPwd"
                                               placeholder="请输入新密码">
                                    </div>
                                </div>
                                <div class="form-group" style="margin-right: 90px;">
                                    <label class="col-md-3 control-label pull-left" style="margin-top: 10px;">确认密码:</label>
                                    <div class="col-md-7">
                                        <input type="password" class="form-control span6" id="reuPwd" name="confirmPwd"
                                               placeholder="请再次输入新密码">
                                    </div>
                                </div>
                                <button class="btn btn-success col-md-6 " id="updateUser" style="margin-left: 50px;">
                                    更新信息
                                </button>
                            </form>
                        </div>
